...
int main(){
    ...
    SBI_I_BruteForce sbi_bf; cout << sbi_bf.firstStableIndex(nums, k) << endl;
    SBI_I_Better sbi_btr; cout << sbi_btr.firstStableIndex(nums, k) << endl;
    SBI_I_Optimal sbi_opt; cout << sbi_opt.firstStableIndex(nums, k) << endl;
    return 0;
}